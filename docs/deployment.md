...
URL: `https://bed-breakfast.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `bed-breakfast.demo.federicocalo.dev`
...
- Output directory: `dist/bed-breakfast/browser`
...
URL: `https://fedcal.github.io/federico-demo-bed-breakfast/`
...
- `base: /federico-demo-bed-breakfast/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `bed-breakfast-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   bed-breakfast-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `bed-breakfast-docs.federicocalo.dev`
