...
const SLUG = 'bed-breakfast';
const TITLE = 'Demo Bed and Breakfast — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Bed and Breakfast.',
  base: `/demo-${SLUG}/`,
  cleanUrls: true,
  ...
  themeConfig: {
    siteTitle: 'Demo Bed and Breakfast',
