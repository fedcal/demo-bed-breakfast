...
import type { InfoAttivita, Camere, Colazione, Team, Faq } from './types';
...
export class MockDataService {
  ...
  readonly colazione$: Observable<Colazione> = this.http
    .get<Colazione>('/assets/mock/colazione.json')
    .pipe(shareReplay(1));
